...
class TestGetFavoritas {
	...
	@Test
		def void sinFavoritos(){
		Assert.assertEquals(0,JoseCampanela.getFavoritas().size)
		
	}
	
	@Test
		def void unFavorito(){
		JoseCampanela.agregarRecetaFavorita(receta1)
		Assert.assertEquals(1,JoseCampanela.getFavoritas().size)

	}
	
	@Test
		def void variosFavorito(){
		JoseCampanela.agregarRecetaFavorita(receta1)
		JoseCampanela.agregarRecetaFavorita(receta2)
		JoseCampanela.agregarRecetaFavorita(receta4)
		Assert.assertEquals(3,JoseCampanela.getFavoritas().size)
