...
class TestRepoUsuarioSinCreacional {
	...
	RepoUsuarios StarlandVocalBand
	...
	def void initPreparacion() {
		...
		StarlandVocalBand = new RepoUsuarios
		
		daniel = new Usuario => [
	    	setNombre("daniel")
	    	setSexo("m")
	    	setFechaDeNacimiento(new Date(01-01-1987))
	    	peso = 80
	    	altura = 1.7
		...
		pablo = new Usuario => [
			...
			solicitarAgregarmeAlGrupo(PinPals)
			agregarReceta(plato4)
			agregarRecetaFavorita(new Receta => [
		     nombrePlato = "favorito"
		     sumarCalorias(100)
